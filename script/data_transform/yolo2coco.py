...
def main():
    root="/home/jovyan/code/liujie/yolov5"
    # file list
    train_file = "/home/jovyan/code/liujie/car_detect/train.txt"
    #class
    class_all_name="/home/jovyan/data-vol-1/trafficcar_ceda/classes.names"
    ...
    for img_file in tqdm(img_files):
        ...
        txt_file=img_file.replace(".jpg",".txt").replace("JPEGImages/","labels_yolo/")
